...
export const LOCALES = ['ja', 'en', 'fr', 'es', 'zh', 'it', 'de', 'pt', 'nl', 'pl', 'tr', 'sv', 'hu'] as const;
...
export const LOCALE_MENU: { locale: Locale; flag: string; label: string }[] = [
  ...
  { locale: 'sv', flag: '🇸🇪', label: 'Svenska' },
  { locale: 'hu', flag: '🇭🇺', label: 'Magyar' },
];
 ...
 */
export const DEFAULT_PLAYBACK_SPEED: Partial<Record<Locale, number>> = {
  ja: 1.5,
  en: 1.2,
  fr: 1.5,
  es: 1.5,
...
export const OUTPUT_LANGUAGE_INSTRUCTION: Partial<Record<Locale, string>> = {
...
export const UI: Record<Locale, UIStrings> = { ja, en, fr, es, zh, it, de, pt, nl, pl, tr, sv, hu };
